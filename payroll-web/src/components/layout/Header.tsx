    ...
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6">
        ...
        {companies.length > 1 && (
          <div className="relative">
            <button
              ...
              aria-label={selectedCompany?.name ? `Current company: ${selectedCompany.name}` : 'Select company'}
            >
            ...
            {showCompanyDropdown && (
              <div className="absolute top-full left-0 mt-1 w-64 bg-white border border-gray-200 rounded-md shadow-lg z-10" role="listbox" aria-label="Select company">
      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          ...
          {showUserDropdown && (
            <div className="absolute top-full right-0 mt-1 w-56 bg-white border border-gray-200 rounded-md shadow-lg z-10" role="menu" aria-label="User menu">
