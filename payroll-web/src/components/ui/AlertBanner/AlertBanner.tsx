...
function generateSystemAlerts(
  ...
  if (payrollCount === 0) {
    alerts.push({
      ...
      message:
        "You haven't created any payroll runs yet. Start by creating your first payroll run.",
      dismissed: false,
    });
  }
  ...
  if (isFriday && payrollCount > 0) {
    alerts.push({
      ...
      message:
        "Review and finalize any pending payroll runs before the weekend.",
      dismissed: false,
    });
  }
  ...
  if (monthEnd && employeeCount > 0) {
    ...
    alerts.push({
      ...
      message:
        "Create next month's payroll run and update any employee changes.",
      dismissed: false,
    });
  }
