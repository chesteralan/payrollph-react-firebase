                ...
                {Array.from({ length: dim }, (_, i) => i + 1).map((day) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative border rounded-lg p-2 text-left transition-colors ${statusColors[status]} ${isToday ? "ring-2 ring-blue-500" : ""}`}
                    >
                      ...
                      .map((app) => (
                        ...
                        >
                          <div>
                            <div className="flex items-center gap-2">
                              <span
                                className={`inline-flex px-2 py-0.5 text-xs font-medium rounded-full ${leaveStatusColors[app.status]}`}
                              >
                                {app.status}
                              </span>
                          ...
                          {canEdit("employees", "calendar") &&
                            app.status === "pending" && (
                              <div className="flex gap-1">
                                <Button
                                  variant="ghost"
                                  size="sm"
                                  onClick={() => approveLeave(app)}
                                >
