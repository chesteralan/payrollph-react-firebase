              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      defaultWorkdays: Number(e.target.value),
                    })
                  }
                />
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, printHeader: e.target.value })
                  }
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, printFooter: e.target.value })
                  }
              ...
              <div className="border-t pt-4">
                ...
                {formData.payrollPeriods.length === 0 ? (
                  <p className="text-sm text-gray-500">
                    No payroll periods configured. Click "Add Period" to
                    configure.
                  </p>
                ) : (
