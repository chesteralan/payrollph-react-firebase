...
// Encrypt data
export const encrypt = async (data: string, passphrase: string): Promise<string> => {
  if (!data) return ''
...
// Decrypt data
export const decrypt = async (encryptedData: string, passphrase: string): Promise<string> => {
