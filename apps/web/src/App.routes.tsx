...
const EmployeeProfilePage = lazyNamed(
  () => import("./pages/employees/EmployeeProfilePage"),
  "EmployeeProfilePage",
);
const EmployeeCalendarPage = lazyNamed(
  () => import("./pages/employees/CalendarPage"),
  "EmployeeCalendarPage",
);
const EmployeeGroupsPage = lazyNamed(
  () => import("./pages/employees/GroupsPage"),
  "EmployeeGroupsPage",
);
const PositionsPage = lazyNamed(
  () => import("./pages/employees/PositionsPage"),
  "PositionsPage",
);
const AreasPage = lazyNamed(
  () => import("./pages/employees/AreasPage"),
  "AreasPage",
);
const NamesListPage = lazyNamed(
  () => import("./pages/lists/NamesListPage"),
  "NamesListPage",
);
const BenefitsPage = lazyNamed(
  () => import("./pages/lists/ListPages"),
  "BenefitsPage",
);
const EarningsPage = lazyNamed(
  () => import("./pages/lists/ListPages"),
  "EarningsPage",
);
const DeductionsPage = lazyNamed(
  () => import("./pages/lists/ListPages"),
  "DeductionsPage",
);
const PayrollRunsPage = lazyNamed(
  () => import("./pages/payroll/PayrollRunsPage"),
  "PayrollRunsPage",
);
const PayrollWizardPage = lazyNamed(
  () => import("./pages/payroll/PayrollWizardPage"),
  "PayrollWizardPage",
);
const PayrollDetailPage = lazyNamed(
  () => import("./pages/payroll/PayrollDetailPage"),
  "PayrollDetailPage",
);
const TemplatesPage = lazyNamed(
  () => import("./pages/payroll/TemplatesPage"),
  "TemplatesPage",
);
const PrintFormatsPage = lazyNamed(
  () => import("./pages/payroll/PrintFormatsPage"),
  "PrintFormatsPage",
);
const DTRPage = lazyNamed(() => import("./pages/dtr/DTRPage"), "DTRPage");
const Report13thMonthPage = lazyNamed(
  () => import("./pages/reports/Report13thMonthPage"),
  "Report13thMonthPage",
);
const PayrollSummaryPage = lazyNamed(
  () => import("./pages/reports/PayrollSummaryPage"),
  "PayrollSummaryPage",
);
const EmployeeReportPage = lazyNamed(
  () => import("./pages/reports/EmployeeReportPage"),
  "EmployeeReportPage",
);
const EarningsDeductionsReportPage = lazyNamed(
  () => import("./pages/reports/EarningsDeductionsReportPage"),
  "EarningsDeductionsReportPage",
);
const AttendanceReportPage = lazyNamed(
  () => import("./pages/reports/AttendanceReportPage"),
  "AttendanceReportPage",
);
const BenefitsUtilizationReportPage = lazyNamed(
  () => import("./pages/reports/BenefitsUtilizationReportPage"),
  "BenefitsUtilizationReportPage",
);
const YearEndReportPage = lazyNamed(
  () => import("./pages/reports/YearEndReportPage"),
  "YearEndReportPage",
);
const CompaniesPage = lazyNamed(
  () => import("./pages/system/CompaniesPage"),
  "CompaniesPage",
);
const CompanySettingsPage = lazyNamed(
  () => import("./pages/system/CompanySettingsPage"),
  "CompanySettingsPage",
);
const CalendarPage = lazyNamed(
  () => import("./pages/system/SystemPages"),
  "CalendarPage",
);
...
const UserActivityPage = lazyNamed(
  () => import("./pages/system/SystemPages"),
  "UserActivityPage",
);
const SystemSettingsPage = lazyNamed(
  () => import("./pages/system/SystemSettingsPage"),
  "SystemSettingsPage",
);
const TrashPage = lazyNamed(
  () => import("./pages/system/TrashPage"),
  "TrashPage",
);
const HealthCheckPage = lazyNamed(
  () => import("./pages/system/HealthCheckPage"),
  "HealthCheckPage",
);
